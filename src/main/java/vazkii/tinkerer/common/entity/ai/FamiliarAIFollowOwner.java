...
public class FamiliarAIFollowOwner extends EntityAIBase
{
    private EntityFamiliar thePet;
    ...
    public FamiliarAIFollowOwner(EntityFamiliar par1EntityFamiliar, double par2, float par4, float par5)
    {
        this.thePet = par1EntityFamiliar;
        this.theWorld = par1EntityFamiliar.worldObj;
        this.field_75336_f = par2;
        this.petPathfinder = par1EntityFamiliar.getNavigator();
        this.minDist = par4;
        this.maxDist = par5;
        this.setMutexBits(3);
    }
